...
class TimeClock {
  ...
  TimeClock(this.isTracking, this.startTime, List<PunchCycle> timeCard)
      : timeCard = timeCard ?? <PunchCycle>[];

  factory TimeClock.fromJson(Map<String, dynamic> json) =>
      _$TimeClockFromJson(json);
...
class PunchCycle {
  ...
  factory PunchCycle.fromJson(Map<String, dynamic> json) =>
      _$PunchCycleFromJson(json);
